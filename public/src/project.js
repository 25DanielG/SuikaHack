...
let suikaTimerEnd
let fruitToSpawn = 7;
let watermelonCombine = true;
window.addEventListener("optionTrigger", (event) => {
    watermelonCombine = event.detail.myExtensionOption1;
    fruitToSpawn = parseInt(event.detail.myExtensionOption2);
});
window.__require = function e(t, n, o) {
        ...
        var a = e("../common/PlayerInfo")
          ...
          , m = function(e) {
            ...
            t.prototype.start = function() {
                ...
                this.createOneFruit(fruitToSpawn) // CHANGED
            }
            ,
            t.prototype.update = function(e) {
            ...
            ,
            t.prototype.refreshFruit = function(e) {
                var t = this
                  , n = cc.instantiate(this.fruitPre);
                t.targetFruit.runAction(cc.removeSelf(true))
                t.targetFruit.active = false
                var random_f = 9 // CHANGED
                af.default.Instance.createOneFruit(random_f)
            }
            ,
            ...
            ,
            t.prototype.suikaTime = function(o) {
                try {
                    if (o.getComponent("fruitData").fruitNumber == 10) {
                        suikaTimerSuika = performance.mark("suikaTimerSuika")
                        const suikaTimer_time = performance.measure("suikaTimerStart", "suikaTimerSuika");
                        let milliseconds = suikaTimer_time.startTime;
                        var GameMyScoreResult = document.getElementById("GameMyScoreResult");
                        const ip = GameMyScoreResult.dataset.ip
                        const hostUrl = location.hostname === "localhost" || location.hostname === "127.0.0.1" ? 'http://localhost:8000' : "https://suikagame.com"
                        const data = {
                            ip: ip,
                            suikaTime: milliseconds,
                            score: null
                        }
                        axios.post(hostUrl + '/scores.json', data).then(response=>{}
                        );
                    }
                } catch (e) {
        ...
        var a = e("./GameFunction")
          ...
          , p = function(e) {
            ...
            t.prototype.onTouchEnd = function(e) {
                ...
                this.scheduleOnce(function() {
                    i.default.GameUpdateCtrl && (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(fruitToSpawn),
                    t.createFruitCount++) : 1 == t.createFruitCount ? (a.default.Instance.createOneFruit(fruitToSpawn),
                    t.createFruitCount++) : 2 == t.createFruitCount ? (a.default.Instance.createOneFruit(fruitToSpawn),
                    t.createFruitCount++) : 3 == t.createFruitCount ? (a.default.Instance.createOneFruit(fruitToSpawn),
                    t.createFruitCount++) : 4 == t.createFruitCount ? (a.default.Instance.createOneFruit(fruitToSpawn),
                    t.createFruitCount++) : 5 == t.createFruitCount ? (a.default.Instance.createOneFruit(fruitToSpawn),
                    t.createFruitCount++) : t.createFruitCount > 5 && (a.default.Instance.createOneFruit(/* s.default.RandomInteger(window.difficulty[0], window.difficulty[1]) */fruitToSpawn),
                    t.createFruitCount++))
                }, .5))
            }
            ,
        ...
        cc.Class({
            ...
            gameEnd1: function() {
                ...
                function TweetButtonAction() {
                    var twiTxt = `https://twitter.com/share?hashtags=Watermelongame&url=https://suikagame.com&text=The record for the watermelon game currently being played is ${e.sceneScore.string} Points.`
                    window.open(twiTxt);
                }
        ...
        var a = e("../common/PlayerInfo")
          ...
          , h = function(e) {
            ...
            t.prototype.start = function() {
                ...
                this.lerpCtrl = !0),
                cc.tween(this.adsButton).call(function() {}).delay(.5).call(function() {}).delay(.5).union().repeatForever().start()
            }
            ,
            t.prototype.update = function(e) {
            ...
            t.prototype.adsButtonFunc = function() {
                ...
                if (dataloadState == false) {
                    axios.get(hostUrl + '/my_scores/' + ip.split('.').join('_') + '.json', headers).then(response=>{
                        const fruits_id = function(res) {
                            switch (res) {
                            case 1:
                        ...
                        for (let item of my_suika_score) {
                            ...
                            my_suika_score_text.push('<li class="list-ranking-item">' + '<img src="' + fruits_icon + '" />' + `${minutes}Min ${seconds}Sec` + '</li>');
                        ...
                        for (let item of weekscore) {
                            ...
                            if (weekscore_ranking_count > 3) {
                                ...
                                weekscore_text.push('<li class="list-ranking-item"><span class="rank_icon rank_' + weekscore_ranking_count + '">' + weekscore_ranking_count + '</span>' + '<img src="' + fruits_icon + '" />' + JSON.stringify(item.score) + '</li>');
                            }
                        ...
                        for (let item of suika_score) {
                            ...
                            if (suika_score_count > 3) {
                                ...
                                suika_score_text.push('<li class="list-ranking-item"><span class="rank_icon rank_' + suika_score_count + '">' + suika_score_count + '</span>' + '<img src="' + fruits_icon + '" />' + `${minutes}Min ${seconds}Sec` + '</li>');
                            }
                            suika_score_count++;
                        }
            ...
            t.prototype.UpdateScoreLabel = function(e) {
                if (this.isScoreChange) {
                    ...
                    this.scoreLabel.string = (t * 2).toString()
                }
            }
            ,
            t.prototype.SetScore = function(e) {
    ...
    MainManage: [function(e, t, n) {
          ...
          , r = (e("GameUiTools"),
        {
            ...
            _ajaxLoad: function(e, t, n) {
                var o = cc.loader.getXMLHttpRequest();
            },
            get ajaxLoad_2() {
                return this._ajaxLoad;
            },
            set ajaxLoad_2(value) {
                this._ajaxLoad = value;
            },
            get ajaxLoad_1() {
                return this._ajaxLoad;
            },
            set ajaxLoad_1(value) {
                this._ajaxLoad = value;
            },
            get ajaxLoad() {
                return this._ajaxLoad;
            ...
            reward: function() {
                console.log('reward')
                af.default.Instance.refreshFruit()
            }
        });
        t.exports = r,
        cc._RF.pop()
          ...
          , m = function(e) {
            ...
            t.prototype.onBeginContact = function(e, t, n) {
                ...
                "fruit" == n.node.group) {
                    ...
                    0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber + (1 * multiplescore),
                    ...
                    cc.tween(t.node).to(.1, {
                        ...
                        n.node.destroy(),
                        t.node.destroy()
                    }).start())) : c == r && c == 10 && r == 10 && watermelonCombine ? (
                        this.pengzhuangCount++,
                        a.default.score += 200,
                        u.default.Instance.SetScoreTween(a.default.score),
                        n.node.getComponent(cc.PhysicsCircleCollider).radius = 0,
                        n.node.getComponent(cc.PhysicsCircleCollider).apply(),
